...
class Graph
{
    ...
    bool isCyclicUtil(int v, bool visited[], bool *rs,vector<int> &path);  // used by isCyclic()
    public:
...
vector<int> path;
bool Graph::isCyclicUtil(int v, bool visited[], bool *recStack,vector<int> &path)
{
    if(visited[v] == false)
    {
